  ...
  add_file("parse_tree.proto", :syntax => :proto3) do
    add_message "pg_query.Node" do
      oneof :node do
        ...
        optional :sql_value_function, :message, 36, "pg_query.SQLValueFunction"
        ...
        optional :create_p_lang_stmt, :message, 98, "pg_query.CreatePLangStmt"
        ...
        optional :drop_owned_stmt, :message, 125, "pg_query.DropOwnedStmt"
        optional :reassign_owned_stmt, :message, 126, "pg_query.ReassignOwnedStmt"
        optional :composite_type_stmt, :message, 127, "pg_query.CompositeTypeStmt"
        optional :create_enum_stmt, :message, 128, "pg_query.CreateEnumStmt"
        optional :create_range_stmt, :message, 129, "pg_query.CreateRangeStmt"
        optional :alter_enum_stmt, :message, 130, "pg_query.AlterEnumStmt"
        optional :alter_ts_dictionary_stmt, :message, 131, "pg_query.AlterTSDictionaryStmt"
        optional :alter_ts_configuration_stmt, :message, 132, "pg_query.AlterTSConfigurationStmt"
        optional :create_fdw_stmt, :message, 133, "pg_query.CreateFdwStmt"
        optional :alter_fdw_stmt, :message, 134, "pg_query.AlterFdwStmt"
        optional :create_foreign_server_stmt, :message, 135, "pg_query.CreateForeignServerStmt"
        optional :alter_foreign_server_stmt, :message, 136, "pg_query.AlterForeignServerStmt"
        optional :create_user_mapping_stmt, :message, 137, "pg_query.CreateUserMappingStmt"
        optional :alter_user_mapping_stmt, :message, 138, "pg_query.AlterUserMappingStmt"
        optional :drop_user_mapping_stmt, :message, 139, "pg_query.DropUserMappingStmt"
        optional :alter_table_space_options_stmt, :message, 140, "pg_query.AlterTableSpaceOptionsStmt"
        optional :alter_table_move_all_stmt, :message, 141, "pg_query.AlterTableMoveAllStmt"
        optional :sec_label_stmt, :message, 142, "pg_query.SecLabelStmt"
        optional :create_foreign_table_stmt, :message, 143, "pg_query.CreateForeignTableStmt"
        optional :import_foreign_schema_stmt, :message, 144, "pg_query.ImportForeignSchemaStmt"
        optional :create_extension_stmt, :message, 145, "pg_query.CreateExtensionStmt"
        optional :alter_extension_stmt, :message, 146, "pg_query.AlterExtensionStmt"
        optional :alter_extension_contents_stmt, :message, 147, "pg_query.AlterExtensionContentsStmt"
        optional :create_event_trig_stmt, :message, 148, "pg_query.CreateEventTrigStmt"
        optional :alter_event_trig_stmt, :message, 149, "pg_query.AlterEventTrigStmt"
        optional :refresh_mat_view_stmt, :message, 150, "pg_query.RefreshMatViewStmt"
        optional :replica_identity_stmt, :message, 151, "pg_query.ReplicaIdentityStmt"
        optional :alter_system_stmt, :message, 152, "pg_query.AlterSystemStmt"
        optional :create_policy_stmt, :message, 153, "pg_query.CreatePolicyStmt"
        optional :alter_policy_stmt, :message, 154, "pg_query.AlterPolicyStmt"
        optional :create_transform_stmt, :message, 155, "pg_query.CreateTransformStmt"
        optional :create_am_stmt, :message, 156, "pg_query.CreateAmStmt"
        optional :create_publication_stmt, :message, 157, "pg_query.CreatePublicationStmt"
        optional :alter_publication_stmt, :message, 158, "pg_query.AlterPublicationStmt"
        optional :create_subscription_stmt, :message, 159, "pg_query.CreateSubscriptionStmt"
        optional :alter_subscription_stmt, :message, 160, "pg_query.AlterSubscriptionStmt"
        optional :drop_subscription_stmt, :message, 161, "pg_query.DropSubscriptionStmt"
        optional :create_stats_stmt, :message, 162, "pg_query.CreateStatsStmt"
        optional :alter_collation_stmt, :message, 163, "pg_query.AlterCollationStmt"
        optional :call_stmt, :message, 164, "pg_query.CallStmt"
        optional :a_expr, :message, 165, "pg_query.A_Expr"
        optional :column_ref, :message, 166, "pg_query.ColumnRef"
        optional :param_ref, :message, 167, "pg_query.ParamRef"
        optional :a_const, :message, 168, "pg_query.A_Const"
        optional :func_call, :message, 169, "pg_query.FuncCall"
        optional :a_star, :message, 170, "pg_query.A_Star"
        optional :a_indices, :message, 171, "pg_query.A_Indices"
        optional :a_indirection, :message, 172, "pg_query.A_Indirection"
        optional :a_array_expr, :message, 173, "pg_query.A_ArrayExpr"
        optional :res_target, :message, 174, "pg_query.ResTarget"
        optional :multi_assign_ref, :message, 175, "pg_query.MultiAssignRef"
        optional :type_cast, :message, 176, "pg_query.TypeCast"
        optional :collate_clause, :message, 177, "pg_query.CollateClause"
        optional :sort_by, :message, 178, "pg_query.SortBy"
        optional :window_def, :message, 179, "pg_query.WindowDef"
        optional :range_subselect, :message, 180, "pg_query.RangeSubselect"
        optional :range_function, :message, 181, "pg_query.RangeFunction"
        optional :range_table_sample, :message, 182, "pg_query.RangeTableSample"
        optional :range_table_func, :message, 183, "pg_query.RangeTableFunc"
        optional :range_table_func_col, :message, 184, "pg_query.RangeTableFuncCol"
        optional :type_name, :message, 185, "pg_query.TypeName"
        optional :column_def, :message, 186, "pg_query.ColumnDef"
        optional :index_elem, :message, 187, "pg_query.IndexElem"
        optional :constraint, :message, 188, "pg_query.Constraint"
        optional :def_elem, :message, 189, "pg_query.DefElem"
        optional :range_tbl_entry, :message, 190, "pg_query.RangeTblEntry"
        optional :range_tbl_function, :message, 191, "pg_query.RangeTblFunction"
        optional :table_sample_clause, :message, 192, "pg_query.TableSampleClause"
        optional :with_check_option, :message, 193, "pg_query.WithCheckOption"
        optional :sort_group_clause, :message, 194, "pg_query.SortGroupClause"
        optional :grouping_set, :message, 195, "pg_query.GroupingSet"
        optional :window_clause, :message, 196, "pg_query.WindowClause"
        optional :object_with_args, :message, 197, "pg_query.ObjectWithArgs"
        optional :access_priv, :message, 198, "pg_query.AccessPriv"
        optional :create_op_class_item, :message, 199, "pg_query.CreateOpClassItem"
        optional :table_like_clause, :message, 200, "pg_query.TableLikeClause"
        optional :function_parameter, :message, 201, "pg_query.FunctionParameter"
        optional :locking_clause, :message, 202, "pg_query.LockingClause"
        optional :row_mark_clause, :message, 203, "pg_query.RowMarkClause"
        optional :xml_serialize, :message, 204, "pg_query.XmlSerialize"
        optional :with_clause, :message, 205, "pg_query.WithClause"
        optional :infer_clause, :message, 206, "pg_query.InferClause"
        optional :on_conflict_clause, :message, 207, "pg_query.OnConflictClause"
        optional :common_table_expr, :message, 208, "pg_query.CommonTableExpr"
        optional :role_spec, :message, 209, "pg_query.RoleSpec"
        optional :trigger_transition, :message, 210, "pg_query.TriggerTransition"
        optional :partition_elem, :message, 211, "pg_query.PartitionElem"
        optional :partition_spec, :message, 212, "pg_query.PartitionSpec"
        optional :partition_bound_spec, :message, 213, "pg_query.PartitionBoundSpec"
        optional :partition_range_datum, :message, 214, "pg_query.PartitionRangeDatum"
        optional :partition_cmd, :message, 215, "pg_query.PartitionCmd"
        optional :vacuum_relation, :message, 216, "pg_query.VacuumRelation"
        optional :inline_code_block, :message, 217, "pg_query.InlineCodeBlock"
        optional :call_context, :message, 218, "pg_query.CallContext"
        optional :integer, :message, 219, "pg_query.Integer"
        optional :float, :message, 220, "pg_query.Float"
        optional :string, :message, 221, "pg_query.String"
        optional :bit_string, :message, 222, "pg_query.BitString"
        optional :null, :message, 223, "pg_query.Null"
        optional :list, :message, 224, "pg_query.List"
        optional :int_list, :message, 225, "pg_query.IntList"
        optional :oid_list, :message, 226, "pg_query.OidList"
      end
    end
    ...
    add_message "pg_query.Var" do
      ...
      optional :varnoold, :uint32, 8
      optional :varoattno, :int32, 9
    ...
    add_message "pg_query.Query" do
      ...
      optional :has_target_sr_fs, :bool, 8
      ...
      repeated :row_marks, :message, 30, "pg_query.Node"
      optional :set_operations, :message, 31, "pg_query.Node"
      repeated :constraint_deps, :message, 32, "pg_query.Node"
      repeated :with_check_options, :message, 33, "pg_query.Node"
      optional :stmt_location, :int32, 34
      optional :stmt_len, :int32, 35
    end
    ...
    add_message "pg_query.SelectStmt" do
      ...
      repeated :locking_clause, :message, 13, "pg_query.Node"
      optional :with_clause, :message, 14, "pg_query.WithClause"
    ...
    add_message "pg_query.IndexStmt" do
      ...
      optional :unique, :bool, 13
      optional :primary, :bool, 14
      optional :isconstraint, :bool, 15
      optional :deferrable, :bool, 16
      optional :initdeferred, :bool, 17
      optional :transformed, :bool, 18
      optional :concurrent, :bool, 19
      optional :if_not_exists, :bool, 20
      optional :reset_default_tblspc, :bool, 21
    end
    ...
    add_message "pg_query.CreateForeignTableStmt" do
      optional :base, :message, 1, "pg_query.CreateStmt"
      optional :servername, :string, 2
      repeated :options, :message, 3, "pg_query.Node"
    end
    ...
    add_message "pg_query.IndexElem" do
      ...
      optional :ordering, :enum, 6, "pg_query.SortByDir"
      optional :nulls_ordering, :enum, 7, "pg_query.SortByNulls"
    end
    ...
    add_message "pg_query.RangeTblEntry" do
      ...
      repeated :joinaliasvars, :message, 9, "pg_query.Node"
      repeated :functions, :message, 10, "pg_query.Node"
      optional :funcordinality, :bool, 11
      optional :tablefunc, :message, 12, "pg_query.TableFunc"
      repeated :values_lists, :message, 13, "pg_query.Node"
      optional :ctename, :string, 14
      optional :ctelevelsup, :uint32, 15
      optional :self_reference, :bool, 16
      repeated :coltypes, :message, 17, "pg_query.Node"
      repeated :coltypmods, :message, 18, "pg_query.Node"
      repeated :colcollations, :message, 19, "pg_query.Node"
      optional :enrname, :string, 20
      optional :enrtuples, :double, 21
      optional :alias, :message, 22, "pg_query.Alias"
      optional :eref, :message, 23, "pg_query.Alias"
      optional :lateral, :bool, 24
      optional :inh, :bool, 25
      optional :in_from_cl, :bool, 26
      optional :required_perms, :uint32, 27
      optional :check_as_user, :uint32, 28
      repeated :security_quals, :message, 29, "pg_query.Node"
    end
    ...
    add_enum "pg_query.AlterTableType" do
      ...
      value :AT_DropNotNull, 4
      value :AT_SetNotNull, 5
      value :AT_CheckNotNull, 6
      value :AT_SetStatistics, 7
      value :AT_SetOptions, 8
      value :AT_ResetOptions, 9
      value :AT_SetStorage, 10
      value :AT_DropColumn, 11
      value :AT_DropColumnRecurse, 12
      value :AT_AddIndex, 13
      value :AT_ReAddIndex, 14
      value :AT_AddConstraint, 15
      value :AT_AddConstraintRecurse, 16
      value :AT_ReAddConstraint, 17
      value :AT_ReAddDomainConstraint, 18
      value :AT_AlterConstraint, 19
      value :AT_ValidateConstraint, 20
      value :AT_ValidateConstraintRecurse, 21
      value :AT_ProcessedConstraint, 22
      value :AT_AddIndexConstraint, 23
      value :AT_DropConstraint, 24
      value :AT_DropConstraintRecurse, 25
      value :AT_ReAddComment, 26
      value :AT_AlterColumnType, 27
      value :AT_AlterColumnGenericOptions, 28
      value :AT_ChangeOwner, 29
      value :AT_ClusterOn, 30
      value :AT_DropCluster, 31
      value :AT_SetLogged, 32
      value :AT_SetUnLogged, 33
      value :AT_DropOids, 34
      value :AT_SetTableSpace, 35
      value :AT_SetRelOptions, 36
      value :AT_ResetRelOptions, 37
      value :AT_ReplaceRelOptions, 38
      value :AT_EnableTrig, 39
      value :AT_EnableAlwaysTrig, 40
      value :AT_EnableReplicaTrig, 41
      value :AT_DisableTrig, 42
      value :AT_EnableTrigAll, 43
      value :AT_DisableTrigAll, 44
      value :AT_EnableTrigUser, 45
      value :AT_DisableTrigUser, 46
      value :AT_EnableRule, 47
      value :AT_EnableAlwaysRule, 48
      value :AT_EnableReplicaRule, 49
      value :AT_DisableRule, 50
      value :AT_AddInherit, 51
      value :AT_DropInherit, 52
      value :AT_AddOf, 53
      value :AT_DropOf, 54
      value :AT_ReplicaIdentity, 55
      value :AT_EnableRowSecurity, 56
      value :AT_DisableRowSecurity, 57
      value :AT_ForceRowSecurity, 58
      value :AT_NoForceRowSecurity, 59
      value :AT_GenericOptions, 60
      value :AT_AttachPartition, 61
      value :AT_DetachPartition, 62
      value :AT_AddIdentity, 63
      value :AT_SetIdentity, 64
      value :AT_DropIdentity, 65
    end
